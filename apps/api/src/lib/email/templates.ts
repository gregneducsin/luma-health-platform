...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>We've received your Luma Health refill order</title>
<!--[if mso]>
<noscript>
<xml>
<o:OfficeDocumentSettings>
...
<div class="email-wrapper">
  <table class="email-container" role="presentation" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
      <td class="body-content">
        ...
        <p class="paragraph" style="margin-bottom:0;">Warmly,<br>The Luma Health Team</p>
      </td>
    </tr>
    <tr>
      <td><hr class="divider" style="margin-left:40px; margin-right:40px;"></td>
  ...
  return { subject: "We've received your Luma Health refill order", html };
}
